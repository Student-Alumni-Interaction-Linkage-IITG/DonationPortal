        ...
        <div className="cardp2">
          ...
          <div className="card-img">
            ...
            <div className="card-contentp2">
              <p className="card-contentp2text">Campus Rush is a virtual recreation of the entire campus for freshers and other to roam around and experience the rush
              </p>
            </div>
            <div><h4 className="heading1p2">Donation Goal</h4></div>
